...
function runTests() {
    ...
    console.assert(getReviewerNumber(3, 2) === 5, "Тест задания 2.1 провален");
    console.assert(getReviewerNumber(15, 3) === 18, "Тест задания 2.1 провален");
    console.assert(getReviewerNumber(20, 4) === 1, "Тест задания 2.1 провален");

    // Задание 2.2
    console.log("=== Задание 2.2 ===");
    console.assert(getVariant(9, "a") === "Аргументы функции должны быть числами", "Тест задания 2.2 провален (не числа)");
    console.assert(getVariant("a", 5) === "Аргументы функции должны быть числами", "Тест задания 2.2 провален (не числа)");
    console.assert(getVariant(10, 5) === 5, "Тест задания 2.2 провален");
    console.assert(getVariant(8, 5) === 3, "Тест задания 2.2 провален");
    console.assert(getVariant(7, 5) === 2, "Тест задания 2.2 провален");
    console.assert(getVariant(6, 5) === 1, "Тест задания 2.2 провален");
    console.assert(getVariant(5, 5) === 5, "Тест задания 2.2 провален");
    console.assert(getVariant(4, 5) === 4, "Тест задания 2.2 провален");
    console.assert(getVariant(3, 5) === 3, "Тест задания 2.2 провален");
    console.assert(getVariant(2, 5) === 2, "Тест задания 2.2 провален");
    console.assert(getVariant(1, 5) === 1, "Тест задания 2.2 провален");

    // Задание 2.3
    console.log("=== Задание 2.3 ===");
    console.assert(calculate(15, 3, '+') === 18, "Тест задания 2.3 провален (+)");
    console.assert(calculate(15, 3, '-') === 12, "Тест задания 2.3 провален (-)");
    console.assert(calculate(15, 3, '*') === 45, "Тест задания 2.3 провален (*)");
    console.assert(calculate(15, 3, '/') === 5, "Тест задания 2.3 провален (/)");
    console.assert(calculate(15, 4, '/') === 3.75, "Тест задания 2.3 провален (float)");
    console.assert(calculate(15, 0, '/') === "Нельзя на 0 делить", "Тест задания 2.3 провален (/0)");
    console.assert(calculate(0, 3, '/') === 0, "Тест задания 2.3 провален (0/)");
    console.assert(calculate(-15, 3, '+') === -12, "Тест задания 2.3 провален (+ отриц)");
    console.assert(calculate(-15, -3, '*') === 45, "Тест задания 2.3 провален (* отриц)");
    console.assert(calculate(2, "b", "+") === "Аргументы функции должны быть числами", "Тест задания 2.3 провален (проверка аргументов)");
    ...
    console.assert(calculateArea("circle", "b") === "Некорректные параметры", "Тест задания 2.4 провален (площадь круга, буква)");
    console.assert(calculateArea("circle", -2) === "Некорректные параметры", "Тест задания 2.4 провален (площадь круга, отрицательное число)");
    console.assert(calculateArea("circle", 0) === "Некорректные параметры", "Тест задания 2.4 провален (площадь круга, 0)");
    console.assert(calculateArea("circle", 3) === 28.274333882308138, "Тест задания 2.4 провален (площадь круга)");

    console.assert(calculateArea("rectangle", 2) === "Должно быть 2 параметра - длина и ширина", "Тест задания 2.4 провален (площадь прямоугольника, 2 параметр)");
    console.assert(calculateArea("rectangle", 2, 2, 2) === "Должно быть 2 параметра - длина и ширина", "Тест задания 2.4 провален (площадь прямоугольника, 2 параметр)");
    console.assert(calculateArea("rectangle", 2, "g") === "Некорректные параметры", "Тест задания 2.4 провален (площадь прямоугольника, буква)");
    console.assert(calculateArea("rectangle", 2, -2) === "Некорректные параметры", "Тест задания 2.4 провален (площадь прямоугольника, отрицательное число)");
    console.assert(calculateArea("rectangle", 2, 0) === "Некорректные параметры", "Тест задания 2.4 провален (площадь прямоугольника, 0)");
    console.assert(calculateArea("rectangle", 3, 5) === 15, "Тест задания 2.4 провален (площадь прямоугольника)");

    console.assert(calculateArea("triangle", 2, 3) === "Должно быть 3 параметра - длины 3 сторон", "Тест задания 2.4 провален (площадь треугольника, 3 параметра)");
    console.assert(calculateArea("triangle", 2, 3, 4, 5) === "Должно быть 3 параметра - длины 3 сторон", "Тест задания 2.4 провален (площадь треугольника, 3 параметра)");
    console.assert(calculateArea("triangle", 2, 3, "g") === "Некорректные параметры", "Тест задания 2.4 провален (площадь треугольника, буква)");
    console.assert(calculateArea("triangle", 2, 3, -2) === "Некорректные параметры", "Тест задания 2.4 провален (площадь треугольника, отрицательное число)");
    console.assert(calculateArea("triangle", 2, 3, 0) === "Некорректные параметры", "Тест задания 2.4 провален (площадь треугольника, 0)");
    console.assert(calculateArea("triangle", 3, 3, 4) === 4.47213595499958, "Тест задания 2.4 провален (площадь треугольника)");

    console.assert(calculateArea("test", 5, 7) === "Неизвестная фигура: test", "Тест задания 2.4 провален (неизвестная фигура)");

    // Задание 2.5
    console.log("=== Задание 2.5 ===");
    console.assert(reverseString("hello") === "olleh", "Тест задания 2.5 провален (перевернутая строка)");
    console.assert(reverseString("") === "", "Тест задания 2.5 провален (пустая строка");
    console.assert(reverseString("b") === "b", "Тест задания 2.5 провален (один символ)");
    console.assert(reverseString(222) === "Входные данные - строка", "Тест задания 2.5 провален (не строка)");

    console.assert(typeof (getRandomNumber(30, 80)) === "number", "Тест задания 2.5 провален (результат не число");
    console.assert(getRandomNumber(30, 80) >= 30 && getRandomNumber(30, 80) < 80, "Тест 2.5 задания провален(результат не в границах");
    ...
    console.log(student.addGrade('chemistry', 92));
    console.log(student.getAverageGrade());
    ...
    console.log(taskManager.addTask("Подготовить презентацию", "high")); //добавление задачи в список
    console.log(taskManager.completeTask(2)); //отметка выполнения задачи
    console.log(taskManager.completeTask(888)); //отметка выполнения несуществующей задачи
    console.log(taskManager.deleteTask(4)); //удаление задачи
    console.log(taskManager.deleteTask(888)); //удаление несуществующей задачи
